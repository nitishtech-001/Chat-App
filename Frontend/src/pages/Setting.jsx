...
import {THEMES,PREVIEW_MESSAGES} from "../constants/index.js"
       ...
       <div className="space-t-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
          {THEMES.map((item,index)=>(
            <button 
            key={index} 
            className={`group flex flex-col items-center gep-1.5 p-2 rounded-lg transition-colors ${theme===item?"bg-base-200":"hover:bg-base-200/50 hover:cursor-pointer"}`}
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Nitish kumar</h3>
